...
\begin{figure}
	\begin{center}
        \subfloat{\label{fig:range-query-iter}\includegraphics[width=0.8\columnwidth]{range-query-iter.pdf}}
	\end{center}
	\caption[Range queries]{
        \subref{fig:range-query-iter} Range query searching for objects with a property $16 \le weight \le 27$ (takes 4 requests w/o cache).
	}
